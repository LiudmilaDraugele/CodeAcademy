...
//padaryti, kad USER galetu keist tik savo pass, o adminai ir visus kitus (visibility klausimas)
//padaryti, kad pridejima, koregavima ir delete nematytu paprasti USER
...
async function createEmployee(e){
	...
	await fetch("http://localhost:8886/planning/api/auth/signup",{
        ...
        body: JSON.stringify({shortname: myemployeeshortname, 
            ...
            password:myemployeepass, repeatPassword:myemployeepassrepeat})
    })
    .then(res => res.json())
    .then(data => { 
